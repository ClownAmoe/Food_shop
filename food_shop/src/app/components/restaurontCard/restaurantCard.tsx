...
export default function RestaurantCard({
  ...
  return (
    <div
      className="flex flex-col justify-around w-[500px] h-[300px] bg-no-repeat bg-cover bg-center rounded-2xl relative text-white z-10 cursor-pointer transition-all"
