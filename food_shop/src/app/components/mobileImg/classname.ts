export const CLASSNAME = {
  ...
  BLACK_PARAGRAPH: "md:text-7xl text-4xl font-bold mt-3",
  TEXT_WRAPPER: "md:-ml-16 inline-block",
  SIMBIOTIC_TEXT:
    "inline-block text-3xl md:bg-paragraph-color md:text-5xl text-center text-nowrap rounded-full py-4 md:px-30 ml-2",
  SIMBIOTIC_START: "underline text-primary-orange",
  SIMBIOTIC_END: "text-black md:text-white",
  PARAGRAPH: "text-2xl mt-6",
  DOWNLOAD_FLEX: "flex flex-row mt-6",
  APPLE_DOWNLOAD: "h-16 w-52",
  GOOGLE_DOWNLOAD: "h-16 w-52 rounded-xl",
};
